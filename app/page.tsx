        ...
        <div className="container px-5 py-24 mx-auto">
          <div className="flex flex-wrap -m-4">
            <div className="p-4 md:w-1/3">
              <div className="h-full border-2 border-gray-200 bg-zinc-50 border-opacity-60 rounded-lg overflow-hidden shadow-2xl shadow-cyan-500/50">
